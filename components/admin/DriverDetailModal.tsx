...
import { X, Star, MapPin, Phone, Mail, Calendar, Car, CreditCard, TrendingUp, CheckCircle, XCircle, Clock, Activity, User, Save, Shield, Ban, Trash2, AlertCircle, DollarSign } from '../../lib/icons';
